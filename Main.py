...
title.config(bg='#5B7C99', fg='white')  
...
font1 = ('times', 13, 'bold')
uploadButton = Button(main, text="Upload Suicide Attempt & Stressed Dataset", command=uploadDataset, bg='#f49f1c')
uploadButton.place(x=900,y=100)
uploadButton.config(font=font1)  

processButton = Button(main, text="Preprocess Dataset", command=processDataset, bg='#f49f1c')
processButton.place(x=900,y=150)
processButton.config(font=font1) 

translationButton = Button(main, text="Machine Translation & Features Extraction", command=translation, bg='#f49f1c')
translationButton.place(x=900,y=200)
translationButton.config(font=font1) 

gbmButton = Button(main, text="Train Propose CNN Algorithm", command=trainCNN, bg='#f49f1c')
gbmButton.place(x=900,y=250)
gbmButton.config(font=font1)

gbmButton = Button(main, text="Train Existing Random Forest Algorithm", command=RFTraining, bg='#f49f1c')
gbmButton.place(x=900,y=300)
gbmButton.config(font=font1) 

predictButton = Button(main, text="Predict Suicidal Attempt from Test Data", command=predict, bg='#f49f1c')
predictButton.place(x=900,y=350)
predictButton.config(font=font1)

graphButton = Button(main, text="Comparison Graph", command=graph, bg='#f49f1c')
graphButton.place(x=900,y=400)
graphButton.config(font=font1)

main.config(bg='#030e4f')
main.mainloop()
